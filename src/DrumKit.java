...
drumLabelWithImage = createLabelImage(image);
    ...
    GridLayout phew=new GridLayout();
   	 ...
   	 String image2="electo_drums.jpg";
    ...
    public void mouseClicked(MouseEvent e) {
   	 ...
   	 if (drumLabelWithImage2==drumClicked){
   		 playSound("electo drums.wav");
   	 }
    }
